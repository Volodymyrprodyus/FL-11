...
$("#list-3 > li:first-child").css({"color" : "yellow"});
...
$( "ul:parent" ).css( "background-color", "green" );
...
$("img[alt*='cat']").css("display", "inherit");
...
$( "div img" ).first().css( {"float" : "left" , "border-color" : "red"} );